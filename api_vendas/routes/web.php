...
Route::get('/cancelar-venda/{saleId}', [VendasController::class, 'cancelarVenda']);
Route::post('/adicionar-produto-venda/{saleId}', [VendasController::class, 'cadastrarProdutoVenda']);
